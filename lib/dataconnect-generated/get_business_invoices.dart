...
class GetBusinessInvoicesVariablesBuilder {
  ...
  final FirebaseDataConnect _dataConnect;  GetBusinessInvoicesVariablesBuilder limit(int? t) {
   _limit.value = t;
   return this;
  }
  ...
  QueryRef<GetBusinessInvoicesData, GetBusinessInvoicesVariables> ref() {
    GetBusinessInvoicesVariables vars= GetBusinessInvoicesVariables(businessId: businessId,limit: _limit,offset: _offset,employeeId: _employeeId,startDate: _startDate,endDate: _endDate,paymentMethod: _paymentMethod,status: _status,searchQuery: _searchQuery,);
    return _dataConnect.query("GetBusinessInvoices", dataDeserializer, varsSerializer, vars);
  }
}

@immutable
class GetBusinessInvoicesInvoices {
  final String id;
  ...
  final String? pdfUrl;
  final GetBusinessInvoicesInvoicesOrder order;
  final List<GetBusinessInvoicesInvoicesInvoiceItemsOnInvoice> invoiceItems_on_invoice;
  GetBusinessInvoicesInvoices.fromJson(dynamic json):
  ...
  order = GetBusinessInvoicesInvoicesOrder.fromJson(json['order']),
  invoiceItems_on_invoice = (json['invoiceItems_on_invoice'] as List<dynamic>)
        .map((e) => GetBusinessInvoicesInvoicesInvoiceItemsOnInvoice.fromJson(e))
        .toList();
  @override
  bool operator ==(Object other) {
    ...
    final GetBusinessInvoicesInvoices otherTyped = other as GetBusinessInvoicesInvoices;
...
@immutable
class GetBusinessInvoicesInvoicesOrder {
  final String id;
  final double price;
  ...
  bool operator ==(Object other) {
    ...
    final GetBusinessInvoicesInvoicesOrder otherTyped = other as GetBusinessInvoicesInvoicesOrder;
    return id == otherTyped.id && 
  ...
  GetBusinessInvoicesInvoicesOrder({
    required this.id,
    required this.price,
    this.serviceName,
    required this.paymentMethod,
...
@immutable
class GetBusinessInvoicesInvoicesOrderClient {
  final String nombreCompleto;
  final String email;
  final String? telefono;
  GetBusinessInvoicesInvoicesOrderClient.fromJson(dynamic json):
  ...
  bool operator ==(Object other) {
    ...
    final GetBusinessInvoicesInvoicesOrderClient otherTyped = other as GetBusinessInvoicesInvoicesOrderClient;
  ...
  GetBusinessInvoicesInvoicesOrderClient({
...
@immutable
class GetBusinessInvoicesInvoicesOrderEmployee {
  final String nombreCompleto;
  final String? telefono;
  GetBusinessInvoicesInvoicesOrderEmployee.fromJson(dynamic json):
  ...
  bool operator ==(Object other) {
    ...
    final GetBusinessInvoicesInvoicesOrderEmployee otherTyped = other as GetBusinessInvoicesInvoicesOrderEmployee;
    return nombreCompleto == otherTyped.nombreCompleto && 
    telefono == otherTyped.telefono;
...
@immutable
class GetBusinessInvoicesInvoicesInvoiceItemsOnInvoice {
  final String id;
  final String serviceName;
  final int quantity;
  final double unitPrice;
  final double total;
  GetBusinessInvoicesInvoicesInvoiceItemsOnInvoice.fromJson(dynamic json):
  ...
  bool operator ==(Object other) {
    ...
    final GetBusinessInvoicesInvoicesInvoiceItemsOnInvoice otherTyped = other as GetBusinessInvoicesInvoicesInvoiceItemsOnInvoice;
    return id == otherTyped.id && 
    serviceName == otherTyped.serviceName && 
  ...
  GetBusinessInvoicesInvoicesInvoiceItemsOnInvoice({
    required this.id,
...
@immutable
class GetBusinessInvoicesData {
  final List<GetBusinessInvoicesInvoices> invoices;
  GetBusinessInvoicesData.fromJson(dynamic json):
  
  invoices = (json['invoices'] as List<dynamic>)
        .map((e) => GetBusinessInvoicesInvoices.fromJson(e))
        .toList();
  @override
  bool operator ==(Object other) {
    if(identical(this, other)) {
    ...
    final GetBusinessInvoicesData otherTyped = other as GetBusinessInvoicesData;
  ...
  GetBusinessInvoicesData({
    required this.invoices,
  });
}

@immutable
class GetBusinessInvoicesVariables {
  ...
  GetBusinessInvoicesVariables.fromJson(Map<String, dynamic> json):
  ...
  bool operator ==(Object other) {
    ...
    final GetBusinessInvoicesVariables otherTyped = other as GetBusinessInvoicesVariables;
  ...
  @override
  int get hashCode => Object.hashAll([businessId.hashCode, limit.hashCode, offset.hashCode, employeeId.hashCode, startDate.hashCode, endDate.hashCode, paymentMethod.hashCode, status.hashCode, searchQuery.hashCode]);
