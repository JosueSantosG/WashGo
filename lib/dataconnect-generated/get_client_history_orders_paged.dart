...
class GetClientHistoryOrdersPagedVariablesBuilder {
  ...
  QueryRef<GetClientHistoryOrdersPagedData, GetClientHistoryOrdersPagedVariables> ref() {
    GetClientHistoryOrdersPagedVariables vars= GetClientHistoryOrdersPagedVariables(limit: limit,offset: offset,);
...
class GetClientHistoryOrdersPagedOrdersBusiness {
  ...
  @override
  int get hashCode => Object.hashAll([id.hashCode, nombre.hashCode, latitud.hashCode, longitud.hashCode]);
